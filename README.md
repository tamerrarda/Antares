...
| Buyer capital | **Premium only** | A bidder never posts strike × notional — only the premium. At the option's fair value that is a capital barrier roughly **136× lower** than physical settlement (and never less than ~23× lower anywhere on the auction curve), which matters most in a thin market. |
